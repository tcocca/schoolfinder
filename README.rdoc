...
This is because Schoolfinder currently does not have an error code 0 (only 1-7, see here: http://www.education.com/webservice/documentation/?section=schoolsearch),
so this would raise a:

  #<Schoolfinder::Error: Schoolfinder Error: a timeout occured (code: 0)>

The following methods are available to the Schoolfinder::Client class, and each method corresponds to an api call.
