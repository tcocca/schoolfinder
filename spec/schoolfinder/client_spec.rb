...
describe "Schoolfinder::Client" do
  ...
  context "school_search" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.school_search(:zip => "29601")}.should_not raise_exception
    end
  end
  ...
  context "test_rating" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.test_rating(:nces_id => "061029001146")}.should_not raise_exception
    end
  end
  ...
  context "student_diversity" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.student_diversity(:nces_id => "450231000564")}.should_not raise_exception
    end
  end
  ...
  context "test_scores" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.test_scores(:nces_id => "450231000564")}.should_not raise_exception
    end
  end
  ...
  context "teacher_stats" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.teacher_stats(:nces_id => "450231000564", :districtleaid => "4502310")}.should_not raise_exception
    end
  end
  ...
  context "student_stats" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.student_stats(:nces_id => "450231000564", :districtleaid => "4502310", :city => "Greenville", :state => "SC")}.should_not raise_exception
    end
  end
  ...
  context "reviews" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.reviews(:schoolid => "25381")}.should_not raise_exception
    end
  end
  ...
  context "number_of" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.number_of("Greenville", "SC")}.should_not raise_exception
    end
  end
  ...
  context "district_search" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.district_search(:city => "Greenville", :state => "SC")}.should_not raise_exception
    end
  end
  ...
  context "branding_data" do
    ...
    it "should not return an error" do
      lambda {@response = @schoolfinder.branding_data(:nces_id => "450231000564")}.should_not raise_exception
    end
  end
